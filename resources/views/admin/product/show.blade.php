        ...
        <div class="main-body p-3">
            ...
            <nav aria-label="breadcrumb" class="main-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Sản phẩm : {{ $pro->ten_san_pham }}</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{Storage::url($pro->hinh_anh)}}" alt="ảnh sản phẩm"
                                    class="rounded-circle" width="200" height="200">
                                <div class="mt-3">
                                    <h4>Sản phẩm : {{ $pro->ten_san_pham }}</h4>
                                    <p class="text-secondary mb-1">Id: {{ $pro->id }}</p>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    {{$pro->loadAllCategory->ten_danh_muc}}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a class="btn btn-info " 
                                        href="{{ route('admin.product.edit', ['id'=>$pro->id]) }}">Sửa</a>
