    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">nhân viên</h3>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-primary btn-round ms-auto" href="{{ route('admin.employee.create') }}">
                                    <i class="fa fa-plus"></i>
                                    Thêm mới
                                </a>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <form id="myForm"
                                                            action="{{ route('admin.employee.destroy', ['id' => $item->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
