        ...
        <div class="main-body p-3">
            ...
            <nav aria-label="breadcrumb" class="main-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Nhân viên: {{ $user->ten_nguoi_dung }}</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{ Storage::url($user->hinh_anh) }}" alt="ảnh Nhân viên" class="rounded-circle"
